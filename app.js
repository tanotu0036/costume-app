  ...
  body.innerHTML=`
    <div style="flex:1;overflow-y:auto;padding:10px 12px 80px">
      ...
      <div class="field"><div class="field-label"><i class="ti ti-calendar"></i>年度 <span class="req">必須</span></div>
        <div class="drum-wrap" id="arDrum" style="width:100%">
          <div class="drum-hl"></div>
          <div class="drum-ft"></div>
          <div class="drum-fb"></div>
          <div class="drum-list" id="arDL"></div>
        </div>
      </div>
...
let dDrag=false,dSY=0,dSO=0,dCO=0;const IH=40;
function initDrum(){
  ...
  dl.innerHTML='';dl.appendChild(pad.cloneNode(true));
  YEARS.forEach((y)=>{const d=document.createElement('div');d.className='drum-item';d.textContent=y+'年度';dl.appendChild(d);});
  dl.appendChild(pad.cloneNode(true));
