            ...
            return `
              <tr style="${isConflict?'background:#FFF8F8':''}">
                ...
                ${showGardens.map(g=>{
                  ...
                  return `<td style="text-align:center;padding:6px 4px;vertical-align:middle;border-top:1px solid #fff;border-bottom:1px solid #fff;border-left:1px solid #fff">
                    ${d?`
