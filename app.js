    ...
    <div style="flex:1;overflow-y:auto;padding:10px 12px 80px">
      ...
      <div class="field"><div class="field-label"><i class="ti ti-calendar"></i>年度 <span class="req">必須</span></div>
        <div class="drum-field">
          <div id="arYearDisplay" style="font-size:22px;font-weight:700;color:var(--gr);min-width:90px;text-align:center"></div>
...
function updDrum(){const dl=document.getElementById('arDL');if(!dl)return;dl.querySelectorAll('.drum-item').forEach((el,i)=>el.classList.toggle('sel',i===drumIdx+1));const yd=document.getElementById('arYearDisplay');if(yd)yd.textContent=YEARS[drumIdx]+'年度';}
